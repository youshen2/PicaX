...
enum AppUpdateService {
    nonisolated static let repositoryURL = URL(string: "https://github.com/youshen2/PicaX")!
    private nonisolated static let latestReleaseURL = URL(string: "https://api.github.com/repos/youshen2/PicaX/releases/latest")!
